...
SECRET_KEY = env(
    "SECRET_KEY",
    default="django-insecure-s64f-ps+!g^ynq&*rvg2%b=#@usf#&^033!jz^@bf1)v8xbvak",
)
...
ROOT_URLCONF = "shared_document_store.urls"
...
WSGI_APPLICATION = "shared_document_store.wsgi.application"
